import { SurveyData, SurveyDataSubset, Response } from './types';

export function subset(data: SurveyData, questionId: string, option: string): SurveyDataSubset {
  // Find the question
...
export function displaySubsetInfo(subsetData: SurveyDataSubset): void {
